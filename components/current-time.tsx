...
export function CurrentTime() {
  ...
  return (
    <div className="group relative hidden items-center gap-1.5 rounded-lg border border-zinc-800 bg-zinc-900 px-2.5 py-1 text-sm transition-colors hover:bg-zinc-800/50 sm:flex">
